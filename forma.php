...
<div class="main-thing" ><div class="rectangle" ></div>
<div class="container mt-5">
    <div class="name" ><div class="rectangle-8" ></div>
    <div class="rectangle-9" ></div>
    <div class="display-3" >Форма</div>
    ...
    <form method="POST" action="forma.php">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control"
                ...
                <div class="mb-3">
            <label for="director" class="form-label">Автор</label>
            <input type="text"
                   class="form-control"
                   id="director"
                   name="director">
